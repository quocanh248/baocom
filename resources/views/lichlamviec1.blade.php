...
@section('content')
    <div class="header-right">
        <label class="title" for="">
            @php
                $gio = $results[0]->giobatdau; // Giả sử $results[0]->gio chứa giá trị ngày tháng
        ...
        <div class="search-box">
            ...
            if(count(Session::get('q' )) > 0)
            {
                ...
                <button class="search" style="text-decoration: none; padding: 8px" href="/lichlamviec" id="lichlamviec">Làm mới</button> 
                @php
                }
            }           
            @endphp
    ...
    <script>
     ...
     $("#lichlamviec").click(function() {

        window.location.href = "/lichlamviec";
    });
</script>
@endsection
