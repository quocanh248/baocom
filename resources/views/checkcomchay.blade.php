...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <div class="number">
                <p id="error-1">SL: 0</p>
                <input type="text" value="{{ count($ktc) }}" id="ktc" hidden>
            </div>
            <div class="day">
                <p>Ngày:</p>
...
<script>
    ...
    var sl = 0;
    var sldk = document.getElementById("ktc");
    document.getElementById("error-1").innerHTML = "SL: " + sldk.value;
