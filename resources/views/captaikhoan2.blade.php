...
@section('content')
    ...
    <div class="container">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <button class="search" id="taotaikhoan123" style="margin-left: 60px; margin-top: 12px; ">Thêm </button>
                            </div>                       
                        </div>
                        <div class="row">
                            <div class="col-12">
        ...
        <table class="fixed_header" id="bangNhanVien" style="font-size: 14px">
            <thead>
                <tr>
                    <th>Mã</th>
                    <th>Tag</th>
            ...
            <tbody>
                @foreach ($dstaikhoan as $data)
                    <tr>
                        ...
                        @php $gv1 = $gv->getquyenuser($data->manhanvien); $dem = 0; @endphp
                        @if(count($gv1) > 0)   
                        <td>          
                            @foreach($gv1 as $d)
                           {{$d ->tenquyen}},                           
                       ...
                       <td></td>
                        ...
                        <td></td>
                        @else
                        <td><button class="search-mini-cv2" value="{{ $data->manhanvien }}" style="background-color: rgb(204, 116, 23)"
                    ...
                    success: function(res) {      
                        ...
                        $.each(res, function(i, item) {                                $
                                ...
                                $.ajax({
                                    ...
                                    type: 'GET',
                                    dataType: 'JSON',
                                    url: '/huyvaitro/' + buttonValue +'/' + cell1Value ,
                                    success: function(res) {
                                      location.reload();
                    ...
                    $.ajax({
                        ...
                        $.each(d, function(i, item) {                                $
                                ...
                                $.ajax({
                                    ...
                                    type: 'GET',
                                    dataType: 'JSON',
                                    url: '/huyvaitro/' + buttonValue +'/' + manhanvien1 ,
                                    success: function(res) {
                                      location.reload();
